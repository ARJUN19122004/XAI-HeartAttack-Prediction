...
* SHAP-based Explainable AI for transparent result interpretation.
* Support for fundus image and vessel segmentation mask inputs.
* Non-invasive, image-based cardiovascular screening method.
* Easily deployable system with modular code structure.
...
3. Mehta, R., & Divya, K. “Predicting Heart Attack Risk through Retinal Images,” IJARCCE, 2024.
4. Johnson, D., & Lee, H. “Automated Cardiovascular Risk Detection from Retinal Images Using Deep Learning,” IEEE Access, 2024.
5. Li, X., & Thompson, R. “Retinal Vascular Biomarkers for Cardiovascular Risk Assessment,” IEEE JBHI, 2023.
